...
@JMSDestinationDefinition(name = HelloWorldMDB.QUEUE, interfaceName = "javax.jms.Queue",
    destinationName = HelloWorldMDB.QUEUE_NAME)
...
public class HelloWorldMDB implements MessageListener {
  ...
  public static final String QUEUE = "java:/queue/" + QUEUE_NAME;
