 ...
 */
public class GetDispatchTrnResultImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements pl.przelewy24.secure.external._71852_php.GetDispatchTrnResult
{
    private static final long serialVersionUID = 1L;
    
    public GetDispatchTrnResultImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public pl.przelewy24.secure.external._71852_php.ArrayOfDispatchTransactionTrn getResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.ArrayOfDispatchTransactionTrn target = null;
            target = (pl.przelewy24.secure.external._71852_php.ArrayOfDispatchTransactionTrn)get_store().find_element_user(RESULT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setResult(pl.przelewy24.secure.external._71852_php.ArrayOfDispatchTransactionTrn result)
    {
     ...
     */
    public pl.przelewy24.secure.external._71852_php.ArrayOfDispatchTransactionTrn addNewResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.ArrayOfDispatchTransactionTrn target = null;
            target = (pl.przelewy24.secure.external._71852_php.ArrayOfDispatchTransactionTrn)get_store().add_element_user(RESULT$0);
            return target;
        }
    }
