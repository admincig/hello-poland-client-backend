 ...
 */
public class RefundTransactionResultImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements pl.przelewy24.secure.external._71852_php.RefundTransactionResult
{
    private static final long serialVersionUID = 1L;
    
    public RefundTransactionResultImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public pl.przelewy24.secure.external._71852_php.ArrayOfSingleRefund getResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.ArrayOfSingleRefund target = null;
            target = (pl.przelewy24.secure.external._71852_php.ArrayOfSingleRefund)get_store().find_element_user(RESULT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setResult(pl.przelewy24.secure.external._71852_php.ArrayOfSingleRefund result)
    {
     ...
     */
    public pl.przelewy24.secure.external._71852_php.ArrayOfSingleRefund addNewResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.ArrayOfSingleRefund target = null;
            target = (pl.przelewy24.secure.external._71852_php.ArrayOfSingleRefund)get_store().add_element_user(RESULT$0);
            return target;
        }
    }
