 ...
 */
public class DispatchTransactionResultImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements pl.przelewy24.secure.external._71852_php.DispatchTransactionResult
{
    private static final long serialVersionUID = 1L;
    
    public DispatchTransactionResultImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public pl.przelewy24.secure.external._71852_php.ArrayOfDispatchInfo getResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.ArrayOfDispatchInfo target = null;
            target = (pl.przelewy24.secure.external._71852_php.ArrayOfDispatchInfo)get_store().find_element_user(RESULT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setResult(pl.przelewy24.secure.external._71852_php.ArrayOfDispatchInfo result)
    {
     ...
     */
    public pl.przelewy24.secure.external._71852_php.ArrayOfDispatchInfo addNewResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.ArrayOfDispatchInfo target = null;
            target = (pl.przelewy24.secure.external._71852_php.ArrayOfDispatchInfo)get_store().add_element_user(RESULT$0);
            return target;
        }
    }
