 ...
 */
public class DispatchImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements pl.przelewy24.secure.external._71852_php.Dispatch
{
    private static final long serialVersionUID = 1L;
    
    public DispatchImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SELLERID$4 = 
    ...
    public int getSellerId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(SELLERID$4, 0);
            if (target == null)
            {
                return 0;
            }
    ...
    public org.apache.xmlbeans.XmlInt xgetSellerId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlInt target = null;
            target = (org.apache.xmlbeans.XmlInt)get_store().find_element_user(SELLERID$4, 0);
            return target;
        }
    }
    ...
    public void setSellerId(int sellerId)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(SELLERID$4);
            }
    ...
    public void xsetSellerId(org.apache.xmlbeans.XmlInt sellerId)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInt)get_store().add_element_user(SELLERID$4);
            }
            target.set(sellerId);
        }
    }
