 ...
 */
public class PaymentMethodsResultImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements pl.przelewy24.secure.external._71852_php.PaymentMethodsResult
{
    private static final long serialVersionUID = 1L;
    
    public PaymentMethodsResultImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public pl.przelewy24.secure.external._71852_php.ArrayOfPaymentMethod getResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.ArrayOfPaymentMethod target = null;
            target = (pl.przelewy24.secure.external._71852_php.ArrayOfPaymentMethod)get_store().find_element_user(RESULT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setResult(pl.przelewy24.secure.external._71852_php.ArrayOfPaymentMethod result)
    {
     ...
     */
    public pl.przelewy24.secure.external._71852_php.ArrayOfPaymentMethod addNewResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.ArrayOfPaymentMethod target = null;
            target = (pl.przelewy24.secure.external._71852_php.ArrayOfPaymentMethod)get_store().add_element_user(RESULT$0);
            return target;
        }
    }
