 ...
 */
public class CompanyRegisterResultImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements pl.przelewy24.secure.external._71852_php.CompanyRegisterResult
{
    private static final long serialVersionUID = 1L;
    
    public CompanyRegisterResultImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public pl.przelewy24.secure.external._71852_php.CompanyOut getResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.CompanyOut target = null;
            target = (pl.przelewy24.secure.external._71852_php.CompanyOut)get_store().find_element_user(RESULT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setResult(pl.przelewy24.secure.external._71852_php.CompanyOut result)
    {
     ...
     */
    public pl.przelewy24.secure.external._71852_php.CompanyOut addNewResult()
    {
        synchronized (monitor())
        {
            check_orphaned();
            pl.przelewy24.secure.external._71852_php.CompanyOut target = null;
            target = (pl.przelewy24.secure.external._71852_php.CompanyOut)get_store().add_element_user(RESULT$0);
            return target;
        }
    }
