...
public class DbFiller extends ServiceSuperclass {
  ...
  private void createImageCollectors() {
    afr = createImageCollector(this.getClass().getResourceAsStream("/images/afrykarium.jpg"));
    hp = createImageCollector(this.getClass().getResourceAsStream("/images/HP.jpg"));
    kol1 = createImageCollector(this.getClass().getResourceAsStream("/images/kolekowo_1.jpg"));
    kol2 = createImageCollector(this.getClass().getResourceAsStream("/images/Kolejkowo_2.jpg"));
    meczLS =
    ...
    stadGd = createImageCollector(
        this.getClass().getResourceAsStream("/images/Stadion_w_Gdańsku_1.jpg"));
    zoo = createImageCollector(this.getClass().getResourceAsStream("/images/zoo.jpg"));
    zwStad = createImageCollector(
        this.getClass().getResourceAsStream("/images/zwiedzanie_stadionu.jpg"));
    zwZoo = createImageCollector(this.getClass().getResourceAsStream("/images/zwiedzanie_zoo.jpg"));
  }
  ...
  private void createSightEvents() {
    afrEvent = createSightEvent(afr, "Wieczorne zwiedzanie Afrykarium",
        ...
        false, userHelloPoland.getPartner());
    parkSzczEvent = createSightEvent(parkSzcz2,
        ...
        false, userHelloPoland.getPartner());
    zwZooEvent = createSightEvent(zwZoo, "Zwiedzanie ZOO",
        ...
        true, userZoo.getPartner());
    zwStadEvent = createSightEvent(zwStad, "Zwiedzanie stadionu",
        ...
        true, userStadionGd.getPartner());
    meczPCEvent = createSightEvent(meczPC, "Mecz towarzyski Polska-Czechy",
        ...
        false, userStadionGd.getPartner());
    kolEvent = createSightEvent(kol1, "Zwiedzanie Kolejkowa",
  ...
  private SightEvent createSightEvent(ImageCollector mainImage, String name, String description,
      Boolean generalAdmission, Partner partner) {
  ...
  private void createTicketPoolDefinitions() {
    createTicketPoolDefinition("Wieczorne zwiedzanie Afrykarium", 25, false,
        getDate("2018-09-29T19:00:00"), getDate("2018-09-29T23:59:59"), DateTypeDTO.DATE,
    ...
    createTicketPoolDefinition("Mecz towarzyski Polska-Czechy", 50, false,
        getDate("2018-11-15T19:00:00"), getDate("2018-11-15T21:00:00"), DateTypeDTO.DATE,
