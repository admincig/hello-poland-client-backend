    ...
    public class Order extends ModelSuperclass {
      ...
      public void generateHash() {
        ...
        @Transient
        public String getCommune() { return details == null ? null : details.getCommune(); }
        public void setCommune(String v) { if (details == null) details = new OrderDetails(); details.setCommune(v); }

        @Transient
        public String getCounty() { return details == null ? null : details.getCounty(); }
        public void setCounty(String v) { if (details == null) details = new OrderDetails(); details.setCounty(v); }

        @Transient
        public String getVoivodeship() { return details == null ? null : details.getVoivodeship(); }
        public void setVoivodeship(String v) { if (details == null) details = new OrderDetails(); details.setVoivodeship(v); }
